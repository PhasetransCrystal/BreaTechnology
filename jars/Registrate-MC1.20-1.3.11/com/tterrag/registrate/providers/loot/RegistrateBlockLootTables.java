...
public class RegistrateBlockLootTables extends VanillaBlockLoot implements RegistrateLootTables {
    ...
    public static LootTable.Builder createSelfDropDispatchTable(Block p_252253_, LootItemCondition.Builder p_248764_, LootPoolEntryContainer.Builder<?> p_249146_) {
        return BlockLootSubProvider.createSelfDropDispatchTable(p_252253_, p_248764_, p_249146_);
    }

    public static LootTable.Builder createSilkTouchDispatchTable(Block p_250203_, LootPoolEntryContainer.Builder<?> p_252089_) {
        return BlockLootSubProvider.createSilkTouchDispatchTable(p_250203_, p_252089_);
    }

    public static LootTable.Builder createShearsDispatchTable(Block p_252195_, LootPoolEntryContainer.Builder<?> p_250102_) {
        return BlockLootSubProvider.createShearsDispatchTable(p_252195_, p_250102_);
    }
    ...
    public static LootTable.Builder createSilkTouchOrShearsDispatchTable(Block p_250539_, LootPoolEntryContainer.Builder<?> p_251459_) {
        return BlockLootSubProvider.createSilkTouchOrShearsDispatchTable(p_250539_, p_251459_);
    }
    ...
    public static LootTable.Builder createSilkTouchOnlyTable(ItemLike p_252216_) {
        return BlockLootSubProvider.createSilkTouchOnlyTable(p_252216_);
    }
    ...
    public static LootTable.Builder createBeeNestDrop(Block p_250988_) {
        return BlockLootSubProvider.createBeeNestDrop(p_250988_);
    }

    public static LootTable.Builder createBeeHiveDrop(Block p_248770_) {
        return BlockLootSubProvider.createBeeHiveDrop(p_248770_);
    }

    public static LootTable.Builder createCaveVinesDrop(Block p_251070_) {
        return BlockLootSubProvider.createCaveVinesDrop(p_251070_);
    }
    ...
    public static LootTable.Builder createDoublePlantShearsDrop(Block p_248678_) {
        return BlockLootSubProvider.createDoublePlantShearsDrop(p_248678_);
    }
    ...
    public RegistrateBlockLootTables(AbstractRegistrate<?> parent, Consumer<RegistrateBlockLootTables> callback) {
        this.parent = parent;
