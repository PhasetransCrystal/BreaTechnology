...
public class RegistrateRecipeProvider extends RecipeProvider implements RegistrateProvider, Consumer<FinishedRecipe> {
    ...
    public ResourceLocation safeId(ItemLike registryEntry) {
        return this.safeId(ForgeRegistries.ITEMS.getKey(registryEntry.asItem()));
    }
    ...
    public String safeName(ItemLike registryEntry) {
        return this.safeName(ForgeRegistries.ITEMS.getKey(registryEntry.asItem()));
    }
    ...
    public <T extends ItemLike> void cooking(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime, String typeName, RecipeSerializer<? extends AbstractCookingRecipe> serializer) {
        SimpleCookingRecipeBuilder var10000 = SimpleCookingRecipeBuilder.generic(source, category, (ItemLike)result.get(), experience, cookingTime, serializer).unlockedBy("has_" + this.safeName(source), source.getCritereon(this));
        ResourceLocation var10002 = this.safeId((ItemLike)result.get());
        var10000.save(this, var10002 + "_from_" + this.safeName(source) + "_" + typeName);
    }
    ...
    public <T extends ItemLike> void smelting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        this.cooking(source, category, result, experience, cookingTime, RecipeSerializer.SMELTING_RECIPE);
    }
    ...
    public <T extends ItemLike> void blasting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        this.cooking(source, category, result, experience, cookingTime, RecipeSerializer.BLASTING_RECIPE);
    }
    ...
    public <T extends ItemLike> void smoking(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        this.cooking(source, category, result, experience, cookingTime, RecipeSerializer.SMOKING_RECIPE);
    }
    ...
    public <T extends ItemLike> void campfire(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, float experience, int cookingTime) {
        this.cooking(source, category, result, experience, cookingTime, RecipeSerializer.CAMPFIRE_COOKING_RECIPE);
    }
    ...
    public <T extends ItemLike> void stonecutting(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int resultAmount) {
        SingleItemRecipeBuilder var10000 = SingleItemRecipeBuilder.stonecutting(source, category, (ItemLike)result.get(), resultAmount).unlockedBy("has_" + this.safeName(source), source.getCritereon(this));
        ResourceLocation var10002 = this.safeId((ItemLike)result.get());
        var10000.save(this, var10002 + "_from_" + this.safeName(source) + "_stonecutting");
    }
    ...
    public <T extends ItemLike> void square(DataIngredient source, RecipeCategory category, Supplier<? extends T> output, boolean small) {
        ShapedRecipeBuilder builder = ShapedRecipeBuilder.shaped(category, (ItemLike)output.get()).define('X', source);
        if (small) {
        ...
        builder.unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)output.get()));
    }
    ...
    public <T extends ItemLike> void storage(DataIngredient source, RecipeCategory category, NonNullSupplier<? extends T> output) {
        ...
        ShapelessRecipeBuilder var10000 = this.singleItemUnfinished(source, category, output, 1, 9);
        ResourceLocation var10002 = this.safeId(source);
        var10000.save(this, var10002 + "_from_" + this.safeName((ItemLike)output.get()));
    }
    ...
    public <T extends ItemLike> void storage(DataIngredient sourceIngredient, RecipeCategory category, NonNullSupplier<? extends T> source, DataIngredient outputIngredient, NonNullSupplier<? extends T> output) {
        ...
        ShapelessRecipeBuilder var10000 = this.singleItemUnfinished(outputIngredient, category, source, 1, 9);
        ResourceLocation var10002 = this.safeId(sourceIngredient);
        var10000.save(this, var10002 + "_from_" + this.safeName((ItemLike)output.get()));
    }
    ...
    public <T extends ItemLike> ShapelessRecipeBuilder singleItemUnfinished(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int required, int amount) {
        return ShapelessRecipeBuilder.shapeless(category, (ItemLike)result.get(), amount).requires(source, required).unlockedBy("has_" + this.safeName(source), source.getCritereon(this));
    }
    ...
    public <T extends ItemLike> void singleItem(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, int required, int amount) {
        this.singleItemUnfinished(source, category, result, required, amount).save(this, this.safeId((ItemLike)result.get()));
    }

    public <T extends ItemLike> void planks(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
        this.singleItemUnfinished(source, category, result, 1, 4).group("planks").save(this, this.safeId((ItemLike)result.get()));
    }
    ...
    public <T extends ItemLike> void stairs(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 4).pattern("X  ").pattern("XX ").pattern("XXX").define('X', source).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
        if (stone) {
    ...
    public <T extends ItemLike> void slab(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group, boolean stone) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 6).pattern("XXX").define('X', source).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
        if (stone) {
    ...
    public <T extends ItemLike> void fence(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 3).pattern("W#W").pattern("W#W").define('W', source).define('#', Items.RODS_WOODEN).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
    }
    ...
    public <T extends ItemLike> void fenceGate(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get()).pattern("#W#").pattern("#W#").define('W', source).define('#', Items.RODS_WOODEN).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
    }

    public <T extends ItemLike> void wall(DataIngredient source, RecipeCategory category, Supplier<? extends T> result) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 6).pattern("XXX").pattern("XXX").define('X', source).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
        this.stonecutting(source, category, result);
    }
    ...
    public <T extends ItemLike> void door(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 3).pattern("XX").pattern("XX").pattern("XX").define('X', source).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
    }
    ...
    public <T extends ItemLike> void trapDoor(DataIngredient source, RecipeCategory category, Supplier<? extends T> result, @Nullable String group) {
        ShapedRecipeBuilder.shaped(category, (ItemLike)result.get(), 2).pattern("XXX").pattern("XXX").define('X', source).group(group).unlockedBy("has_" + this.safeName(source), source.getCritereon(this)).save(this, this.safeId((ItemLike)result.get()));
    }
    ...
    public CompletableFuture<?> buildAdvancement(CachedOutput p_253674_, ResourceLocation p_254102_, Advancement.Builder p_253712_) {
        return super.buildAdvancement(p_253674_, p_254102_, p_253712_);
    }

    public void generateForEnabledBlockFamilies(Consumer<FinishedRecipe> p_249188_, FeatureFlagSet p_251836_) {
        super.generateForEnabledBlockFamilies(p_249188_, p_251836_);
    }
    ...
    public static void oreSmelting(Consumer<FinishedRecipe> p_250654_, List<ItemLike> p_250172_, RecipeCategory p_250588_, ItemLike p_251868_, float p_250789_, int p_252144_, String p_251687_) {
        RecipeProvider.oreSmelting(p_250654_, p_250172_, p_250588_, p_251868_, p_250789_, p_252144_, p_251687_);
    }
    ...
    public static void oreBlasting(Consumer<FinishedRecipe> p_248775_, List<ItemLike> p_251504_, RecipeCategory p_248846_, ItemLike p_249735_, float p_248783_, int p_250303_, String p_251984_) {
        RecipeProvider.oreBlasting(p_248775_, p_251504_, p_248846_, p_249735_, p_248783_, p_250303_, p_251984_);
    }
    ...
    public static void oreCooking(Consumer<FinishedRecipe> p_250791_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
        RecipeProvider.oreCooking(p_250791_, p_251817_, p_249619_, p_251154_, p_250066_, p_251871_, p_251316_, p_251450_, p_249236_);
    }
    ...
    public static void netheriteSmithing(Consumer<FinishedRecipe> p_251614_, Item p_250046_, RecipeCategory p_248986_, Item p_250389_) {
        RecipeProvider.netheriteSmithing(p_251614_, p_250046_, p_248986_, p_250389_);
    }

    public static void trimSmithing(Consumer<FinishedRecipe> p_285086_, Item p_285461_, ResourceLocation p_285044_) {
        RecipeProvider.trimSmithing(p_285086_, p_285461_, p_285044_);
    }
    ...
    public static void twoByTwoPacker(Consumer<FinishedRecipe> p_248860_, RecipeCategory p_250881_, ItemLike p_252184_, ItemLike p_249710_) {
        RecipeProvider.twoByTwoPacker(p_248860_, p_250881_, p_252184_, p_249710_);
    }
    ...
    public static void threeByThreePacker(Consumer<FinishedRecipe> p_259036_, RecipeCategory p_259247_, ItemLike p_259376_, ItemLike p_259717_, String p_260308_) {
        RecipeProvider.threeByThreePacker(p_259036_, p_259247_, p_259376_, p_259717_, p_260308_);
    }
    ...
    public static void threeByThreePacker(Consumer<FinishedRecipe> p_260012_, RecipeCategory p_259186_, ItemLike p_259360_, ItemLike p_259263_) {
        RecipeProvider.threeByThreePacker(p_260012_, p_259186_, p_259360_, p_259263_);
    }
    ...
    public static void planksFromLog(Consumer<FinishedRecipe> p_259712_, ItemLike p_259052_, TagKey<Item> p_259045_, int p_259471_) {
        RecipeProvider.planksFromLog(p_259712_, p_259052_, p_259045_, p_259471_);
    }
    ...
    public static void planksFromLogs(Consumer<FinishedRecipe> p_259910_, ItemLike p_259193_, TagKey<Item> p_259818_, int p_259807_) {
        RecipeProvider.planksFromLogs(p_259910_, p_259193_, p_259818_, p_259807_);
    }
    ...
    public static void woodenBoat(Consumer<FinishedRecipe> p_126022_, ItemLike p_126023_, ItemLike p_126024_) {
        RecipeProvider.woodenBoat(p_126022_, p_126023_, p_126024_);
    }

    public static void chestBoat(Consumer<FinishedRecipe> p_236372_, ItemLike p_236373_, ItemLike p_236374_) {
        RecipeProvider.chestBoat(p_236372_, p_236373_, p_236374_);
    }
    ...
    public static void pressurePlate(Consumer<FinishedRecipe> p_176691_, ItemLike p_176692_, ItemLike p_176693_) {
        RecipeProvider.pressurePlate(p_176691_, p_176692_, p_176693_);
    }
    ...
    public static void slab(Consumer<FinishedRecipe> p_248880_, RecipeCategory p_251848_, ItemLike p_249368_, ItemLike p_252133_) {
        RecipeProvider.slab(p_248880_, p_251848_, p_249368_, p_252133_);
    }
    ...
    public static void hangingSign(Consumer<FinishedRecipe> p_250663_, ItemLike p_252355_, ItemLike p_250437_) {
        RecipeProvider.hangingSign(p_250663_, p_252355_, p_250437_);
    }

    public static void colorBlockWithDye(Consumer<FinishedRecipe> p_289666_, List<Item> p_289675_, List<Item> p_289672_, String p_289641_) {
        RecipeProvider.colorBlockWithDye(p_289666_, p_289675_, p_289672_, p_289641_);
    }

    public static void carpet(Consumer<FinishedRecipe> p_176717_, ItemLike p_176718_, ItemLike p_176719_) {
        RecipeProvider.carpet(p_176717_, p_176718_, p_176719_);
    }

    public static void bedFromPlanksAndWool(Consumer<FinishedRecipe> p_126074_, ItemLike p_126075_, ItemLike p_126076_) {
        RecipeProvider.bedFromPlanksAndWool(p_126074_, p_126075_, p_126076_);
    }

    public static void banner(Consumer<FinishedRecipe> p_126082_, ItemLike p_126083_, ItemLike p_126084_) {
        RecipeProvider.banner(p_126082_, p_126083_, p_126084_);
    }

    public static void stainedGlassFromGlassAndDye(Consumer<FinishedRecipe> p_126086_, ItemLike p_126087_, ItemLike p_126088_) {
        RecipeProvider.stainedGlassFromGlassAndDye(p_126086_, p_126087_, p_126088_);
    }
    ...
    public static void stainedGlassPaneFromStainedGlass(Consumer<FinishedRecipe> p_126090_, ItemLike p_126091_, ItemLike p_126092_) {
        RecipeProvider.stainedGlassPaneFromStainedGlass(p_126090_, p_126091_, p_126092_);
    }
    ...
    public static void stainedGlassPaneFromGlassPaneAndDye(Consumer<FinishedRecipe> p_126094_, ItemLike p_126095_, ItemLike p_126096_) {
        RecipeProvider.stainedGlassPaneFromGlassPaneAndDye(p_126094_, p_126095_, p_126096_);
    }
    ...
    public static void polished(Consumer<FinishedRecipe> p_251348_, RecipeCategory p_248719_, ItemLike p_250032_, ItemLike p_250021_) {
        RecipeProvider.polished(p_251348_, p_248719_, p_250032_, p_250021_);
    }
    ...
    public static void cut(Consumer<FinishedRecipe> p_248712_, RecipeCategory p_252306_, ItemLike p_249686_, ItemLike p_251100_) {
        RecipeProvider.cut(p_248712_, p_252306_, p_249686_, p_251100_);
    }
    ...
    public static void chiseled(Consumer<FinishedRecipe> p_250120_, RecipeCategory p_251604_, ItemLike p_251049_, ItemLike p_252267_) {
        RecipeProvider.chiseled(p_250120_, p_251604_, p_251049_, p_252267_);
    }
    ...
    public static void mosaicBuilder(Consumer<FinishedRecipe> p_249200_, RecipeCategory p_248788_, ItemLike p_251925_, ItemLike p_252242_) {
        RecipeProvider.mosaicBuilder(p_249200_, p_248788_, p_251925_, p_252242_);
    }
    ...
    public static void stonecutterResultFromBase(Consumer<FinishedRecipe> p_251589_, RecipeCategory p_248911_, ItemLike p_251265_, ItemLike p_250033_) {
        RecipeProvider.stonecutterResultFromBase(p_251589_, p_248911_, p_251265_, p_250033_);
    }
    ...
    public static void stonecutterResultFromBase(Consumer<FinishedRecipe> p_249145_, RecipeCategory p_250609_, ItemLike p_251254_, ItemLike p_249666_, int p_251462_) {
        RecipeProvider.stonecutterResultFromBase(p_249145_, p_250609_, p_251254_, p_249666_, p_251462_);
    }

    public static void smeltingResultFromBase(Consumer<FinishedRecipe> p_176740_, ItemLike p_176741_, ItemLike p_176742_) {
        RecipeProvider.smeltingResultFromBase(p_176740_, p_176741_, p_176742_);
    }
    ...
    public static void nineBlockStorageRecipes(Consumer<FinishedRecipe> p_249580_, RecipeCategory p_251203_, ItemLike p_251689_, RecipeCategory p_251376_, ItemLike p_248771_) {
        RecipeProvider.nineBlockStorageRecipes(p_249580_, p_251203_, p_251689_, p_251376_, p_248771_);
    }
    ...
    public static void nineBlockStorageRecipesWithCustomPacking(Consumer<FinishedRecipe> p_250488_, RecipeCategory p_250885_, ItemLike p_251651_, RecipeCategory p_250874_, ItemLike p_248576_, String p_250171_, String p_249386_) {
        RecipeProvider.nineBlockStorageRecipesWithCustomPacking(p_250488_, p_250885_, p_251651_, p_250874_, p_248576_, p_250171_, p_249386_);
    }
    ...
    public static void nineBlockStorageRecipesRecipesWithCustomUnpacking(Consumer<FinishedRecipe> p_250320_, RecipeCategory p_248979_, ItemLike p_249101_, RecipeCategory p_252036_, ItemLike p_250886_, String p_248768_, String p_250847_) {
        RecipeProvider.nineBlockStorageRecipesRecipesWithCustomUnpacking(p_250320_, p_248979_, p_249101_, p_252036_, p_250886_, p_248768_, p_250847_);
    }

    public static void copySmithingTemplate(Consumer<FinishedRecipe> p_267061_, ItemLike p_266974_, TagKey<Item> p_267283_) {
        RecipeProvider.copySmithingTemplate(p_267061_, p_266974_, p_267283_);
    }

    public static void copySmithingTemplate(Consumer<FinishedRecipe> p_266734_, ItemLike p_267133_, ItemLike p_267023_) {
        RecipeProvider.copySmithingTemplate(p_266734_, p_267133_, p_267023_);
    }
    ...
    public static void cookRecipes(Consumer<FinishedRecipe> p_126007_, String p_126008_, RecipeSerializer<? extends AbstractCookingRecipe> p_250529_, int p_126010_) {
        RecipeProvider.cookRecipes(p_126007_, p_126008_, p_250529_, p_126010_);
    }
    ...
    public static void simpleCookingRecipe(Consumer<FinishedRecipe> p_249398_, String p_249709_, RecipeSerializer<? extends AbstractCookingRecipe> p_251876_, int p_249258_, ItemLike p_250669_, ItemLike p_250224_, float p_252138_) {
        RecipeProvider.simpleCookingRecipe(p_249398_, p_249709_, p_251876_, p_249258_, p_250669_, p_250224_, p_252138_);
    }

    public static void waxRecipes(Consumer<FinishedRecipe> p_176611_) {
        RecipeProvider.waxRecipes(p_176611_);
    }

    public static void generateRecipes(Consumer<FinishedRecipe> p_176581_, BlockFamily p_176582_) {
        RecipeProvider.generateRecipes(p_176581_, p_176582_);
    }
    ...
    static {
        COOKING_TYPE_NAMES = ImmutableMap.builder().put(RecipeSerializer.SMELTING_RECIPE, "smelting").put(RecipeSerializer.BLASTING_RECIPE, "blasting").put(RecipeSerializer.SMOKING_RECIPE, "smoking").put(RecipeSerializer.CAMPFIRE_COOKING_RECIPE, "campfire").build();
    }
}
