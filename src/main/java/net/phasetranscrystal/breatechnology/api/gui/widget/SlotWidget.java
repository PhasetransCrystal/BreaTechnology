package net.phasetranscrystal.breatechnology.api.gui.widget;
...
import net.phasetranscrystal.breatechnology.integration.xei.handlers.item.CycleItemEntryHandler;
import net.phasetranscrystal.breatechnology.integration.xei.handlers.item.CycleItemStackHandler;
...
public class SlotWidget  extends com.lowdragmc.lowdraglib.gui.widget.SlotWidget {
    ...
    public Object getXEIIngredientOverMouse(double mouseX, double mouseY) {
        if (self().isMouseOverElement(mouseX, mouseY)) {
            ...
            if (BreaTechnology.Mods.isJEILoaded() && !realStack.isEmpty()) {
    ...
    private List<Object> getXEIIngredients(CycleItemStackHandler handler, int index) {
        ...
        if (BreaTechnology.Mods.isJEILoaded()) {
